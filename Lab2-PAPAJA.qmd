...
7.  Your goal is to create the following APA document( <https://github.com/ndphillips/IntroductionR_Course/blob/master/assignments/wpa/studentAPA/studentAPA_comp.pdf?raw=true)> by adding elements to the studentAPA.Rmd document. In a web browser, go to the link above to download the file and see how it looks.
...
-   Try to do the same thing, but use `apaquarto`. Go here and follow the instructions: \<https://github.com/wjschne/apaquarto\>.
